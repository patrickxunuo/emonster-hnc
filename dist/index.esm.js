...
import { Button, Spin, Tooltip, Typography, Space, Menu } from 'antd';
import * as React from 'react';
import React__default, { useRef, useEffect, useState, useCallback, createContext, useContext } from 'react';
...
function useLoading(onSubmit) {
    var _this = this;
    var _a = useState(false), isLoading = _a[0], setIsLoading = _a[1];
    var callRef = useRef(0);
...
function useLeavePageNotification(active, config) {
    ...
    var permRef = useRef(false);
    var notificationRef = useRef();
    var popNote = useCallback(function () {
...
function useThrottle(value, interval) {
    ...
    var lastExecuted = useRef(Date.now());
    useEffect(function () {
...
var AsyncBtn = function (_a) {
    ...
    return (jsx(Button, __assign({}, btnConfigs, { onClick: handleActionLoad, loading: loading || isLoading }, { children: children })));
};
...
var DoubleConfirmBtn = function (_a) {
    ...
    var _f = useState(0), state = _f[0], setState = _f[1];
    ...
    return (jsx(Spin, __assign({ spinning: isLoading || loading, indicator: jsx(LoadingOutlined$1, { style: { fontSize: 16 }, spin: true }) }, { children: jsxs(Button, __assign({ ref: btnRef, className: state === 0
                ? "double-confirm-btn"
                : secondaryType === "save"
                    ? "double-confirm-btn ant-btn-save"
            ...
            }); }, size: size, disabled: isLoading || loading || disabled }, { children: [jsx("span", __assign({ style: { visibility: state === 0 ? "visible" : "hidden" } }, { children: label })), jsx("span", __assign({ style: { visibility: state === 1 ? "visible" : "hidden" } }, { children: secondaryText }))] })) })));
};
...
var MovableTitle = function (_a) {
    ...
    var _b = useState(0), elHeight = _b[0], setElHeight = _b[1];
    var _c = useState(0), elWidth = _c[0], setElWidth = _c[1];
    ...
    return (jsx("div", __assign({ className: "em__movable__tooltip__title", style: __assign(__assign({}, style), { top: y - (elHeight || 0) + offsetY, left: x - (elWidth / 2 || 0) + offsetX, opacity: elHeight }), ref: elRef }, { children: title })));
};
var MovableTooltip = function (_a) {
    var children = _a.children, title = _a.title, floatContentStyle = _a.floatContentStyle;
    var elRef = useRef(null);
    var _b = useState(false), visible = _b[0], setVisible = _b[1];
    return (jsxs(Fragment, { children: [visible && title && title !== EMPTY_TEXT_REPLACER && (jsx(MovableTitle, { title: title, parentRef: elRef, style: __assign({ fontSize: 12, fontWeight: "normal" }, floatContentStyle) })), jsx("div", __assign({ style: { display: "inline-block" }, ref: elRef, onMouseEnter: function () { return setVisible(true); }, onMouseLeave: function () { return setVisible(false); } }, { children: children }))] }));
};

var AbbrText = function (_a) {
    var trans = _a.trans, id = _a.id, _b = _a.movable, movable = _b === void 0 ? false : _b;
    return movable ? (jsx(MovableTooltip, __assign({ title: trans(id) }, { children: trans("".concat(id, ".abbr")) }))) : (jsx(Tooltip, __assign({ title: trans(id) }, { children: trans("".concat(id, ".abbr")) })));
};
...
var LongTextColumn = function (props) {
    ...
    return hoverShow ? (jsxs("div", __assign({ style: { display: "flex", alignItems: "center" } }, { children: [movable ? (jsx(MovableTooltip, __assign({ title: text }, { children: jsx("div", __assign({ style: __assign(__assign({}, style), { textOverflow: "ellipsis", maxWidth: maxWidth, whiteSpace: "nowrap", overflow: "hidden" }) }, { children: text })) }))) : (jsx(Tooltip, __assign({ title: text }, { children: jsx("div", __assign({ style: __assign(__assign({}, style), { textOverflow: "ellipsis", maxWidth: maxWidth, whiteSpace: "nowrap", overflow: "hidden" }) }, { children: text })) }))), text && text !== "-" && copy && (jsxs("a", __assign({ onClick: function (e) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                e.stopPropagation();
                ...
                }); } }, { children: [" ", copied ? jsx(CheckOutlined$1, {}) : jsx(CopyOutlined$1, {})] })))] }))) : (jsxs("div", __assign({ style: { display: "flex", alignItems: "center" } }, { children: [jsx("div", __assign({ style: __assign(__assign({}, style), { textOverflow: "ellipsis", maxWidth: maxWidth, whiteSpace: "nowrap", overflow: "hidden" }) }, { children: text })), text && text !== "-" && copy && (jsxs("a", __assign({ onClick: function (e) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                e.stopPropagation();
                ...
                }); } }, { children: [" ", copied ? jsx(CheckOutlined$1, {}) : jsx(CopyOutlined$1, {})] })))] })));
};
...
var TextAutoScroll = function (_a) {
    ...
    var _f = useState(false), isScrollable = _f[0], setIsScrollable = _f[1];
    var _g = useState("better-text-wrap"), className = _g[0], setClassName = _g[1];
    var _h = useState(false), hovering = _h[0], setHovering = _h[1];
    ...
    return (jsxs(motion.div, __assign({ whileHover: isScrollable
            ? {
            ...
            setHovering(false);
            setClassName("better-text-wrap");
        }, ref: containerRef }, { children: [jsx(Text$1, __assign({ style: __assign({}, style) }, { children: children })), jsx(AnimatePresence, { children: isScrollable && !hovering && (jsx(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1, transition: { delay: 0.5 } }, className: "ellipsis-tag" })) })] })));
};
...
var SpeedDial = function (_a) {
    ...
    var _c = useState(false), visible = _c[0], handleVisible = _c[1];
    var _d = useState(false), hidden = _d[0], setHidden = _d[1];
    ...
    return (jsxs(motion.div, __assign({ className: hidden ? "speed-dial-wrap hidden" : "speed-dial-wrap", ref: wrapRef, style: style }, { children: [jsx(Space, __assign({ className: "speed-dial-trigger" }, { children: jsx(motion.div, __assign({ onClick: function () {
                        if (visible) {
                            handleVisibleFalse();
                        }
                        else {
                    ...
                    // @ts-ignore
                    style: { transform: visible ? "rotate(45deg)" : null } }, { children: jsx(Button, { type: "primary", shape: "circle", icon: jsx(PlusOutlined$1, { style: { fontSize: 20 } }), onClick: function () { return handleVisible(function (v) { return !v; }); }, className: "trigger-btn" }) })) })), jsx(AnimatePresence, { children: visible && (jsx(Menu, __assign({ className: "speed-dial-menu", style: { top: -(actionArray.length * 60) - 5 } }, { children: actionArray.map(function (action, index) { return (jsx(Menu.Item, __assign({ style: { height: 50, display: "flex", alignItems: "center" } }, { children: jsxs(motion.div, __assign({ onMouseEnter: clear, onMouseLeave: reset, style: { backgroundColor: "transparent" }, transition: {
                                duration: 0.12,
                                ...
                                transition: {
                            ...
                            } }, { children: [jsx(Button, { size: "large", icon: action.icon, shape: "circle", onClick: action.onClick, disabled: action.disabled }), jsx(motion.div, __assign({ initial: { scale: 0, opacity: 0.1 }, animate: {
                                        scale: 1,
                                        opacity: 1,
                                        transition: {
                                            duration: 0.25,
                                    ...
                                    }, className: "action-tooltip-container" }, { children: jsx(Text, __assign({ className: "action-tooltip" }, { children: action.tooltip })) }))] })) }), index)); }) }))) })] })));
};

export { AbbrText, AsyncBtn as AsyncButton, DoubleConfirmBtn, LongTextColumn, MovableTooltip, SpeedDial, TextAutoScroll, useClickOutside, useDebounce, useEffectSkipFirst, useEventListener, useLeavePageNotification, useLoading, useMousePosition, useThrottle, useTimeout, useToggle, useWindowSize };
